...
public class TestActiveScore extends TestCase {
    ...
    {
        ActiveScore ac1= new ActiveScore();
        ac1.setBoulderId(1);
        ActiveScore ac2= new ActiveScore();
        ac2.setBoulderId(1);
        assertEquals(0, ac1.compareTo(ac2));            
    }
    ...
    public void testSmaller()
    {
        ...
        ActiveScore ac2= new ActiveScore();
        ac2.setBoulderId(2);
        assertEquals(-1, ac1.compareTo(ac2));            
    }    
    ...
    public void testBigger()
    {
        ...
        ActiveScore ac2= new ActiveScore();
        ac2.setBoulderId(2);
        assertEquals(1, ac2.compareTo(ac1));            
    } 
}
